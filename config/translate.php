...
return [
    'data' => [
        ...
        [
            'group' => 'validation',
            'key' => 'attributes.register_number',
            'text' => [
                'id' => 'Nomor Registrasi',
                'en' => 'Register Number'
            ]
        ...
        [
            ...
            'text' => [
                'id' => 'Jenis Kelamin Ternak',
                'en' => 'Livestock Gender'
            ]
        ],
        [
            'group' => 'validation',
            'key' => 'attributes.racial',
            'text' => [
                'id' => 'Ras Ternak',
                'en' => 'Livestock Racial'
            ]
        ...
        [
            ...
            'text' => [
                'id' => 'Tanggal Lahir Ternak',
                'en' => 'Livestock Birthday'
            ]
        ],
        [
            'group' => 'validation',
            ...
            'text' => [
                'id' => 'Bobot Lahir Ternak',
                'en' => 'Livestock Weight'
            ]
        ],
        [
            'group' => 'validation',
            'key' => 'attributes.lenght',
            'text' => [
                'id' => 'Panjang Badan Lahir Ternak',
                'en' => 'Livestock Lenght'
            ]
        ],
        [
            'group' => 'validation',
            'key' => 'attributes.height',
            'text' => [
                'id' => 'Tinggi Badan Lahir Ternak',
                'en' => 'Livestock Height'
            ]
        ],
        [
            'group' => 'validation',
            'key' => 'attributes.register_number_father',
            'text' => [
                'id' => 'Nomor Registrasi Induk Pejantan Ternak',
                'en' => 'Livestock Register Number Father'
            ]
        ],
        [
            'group' => 'validation',
            'key' => 'attributes.register_number_mother',
            'text' => [
                'id' => 'Nomor Registrasi Induk Betina Ternak Ternak',
                'en' => 'Livestock Register Number Mother'
            ]
        ],
        [
            'group' => 'validation',
